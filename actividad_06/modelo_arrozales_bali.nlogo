...
to elegir_siguiente_itinerario
  ...
  if regla_decision = "mayoria" [
    let itinerarios_vecinos [I_t] of vecinos_cosecha
    let moda_itinerario modes itinerarios_vecinos
    set I_t1 one-of moda_itinerario
    stop
  ]
